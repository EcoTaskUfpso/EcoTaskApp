  ...
  Future<void> _useCoupon(Coupon coupon) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Confirmar Uso de Cupón'),
          content: Column(
            ...
            children: [
              ...
              Text(
                'Valor: ${coupon.value.toStringAsFixed(0)}% de descuento',
              ...
              const Text(
                '¿Johan confirma que desea usar este cupón?',
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Johan ha reclamado exitosamente el cupón ${coupon.code}',
                    textAlign: TextAlign.center,
                  ),
                  const SizedBox(height: 8),
                  Text(
                    'Descuento: ${coupon.value.toStringAsFixed(0)}%',
